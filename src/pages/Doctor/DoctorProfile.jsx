...
const DoctorProfile = () => {
  ...
  useEffect(() => {
    console.log("Profile Data updated:", profileData); // Log profile data to ensure it's updated
  }, [profileData]); // Whenever profileData changes, this will log the new profile data
    ...
    <div >
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          <p className='text-gray-600 font-medium mt-4'>Appointment Fee: <span className='text-gray-800'>{currency} {isEdit ? <input type="number" onChange={(e) => setProfileData(prev => ({ ...prev, fess: Number(e.target.value) }))} value={profileData.fess} /> : profileData.fess}</span></p>
